...
export default {
  ...
  data() {
    return {
      ...
      catLevel1: { // there will be x number of levels, all with the same structure
      ...
      catLevel2: {
        title: "Selectors",
        instructions: `Sass will let you nest your CSS selectors in a way that follows the same visual hierarchy of your HTML. Be aware that overly nested rules will result in over-qualified CSS that could prove hard to maintain and is generally considered bad practice. With that knowledge, drag the selectors below to their correct nested spots to style the cat's mouth!\n`,
        code: [
        ...
        answers: [
          { text: ".cat-face", used: false },
          { text: ".cat-mouth", used: false },
      ...
      catLevel3: {
        title: "Mixins",
        instructions: `Mixins are a powerful way to reuse CSS rules. They allow you to define a set of CSS rules once, and then reuse them multiple times throughout your code. Drag the correct mixin names and values below to the correct spots to create the cat's ears.`,
        code: [
          {
            content:
          ...
          {
            content: "___________ (#5)\n\n\t @include cat-ear($primary-color)",
          },
        ],
        answers: [
          { text: "$color", used: false },
          { text: "100px", used: false },
          { text: "70px", used: false },
          { text: "cat-ear", used: false },
          { text: ".cat-ear-right", used: false },
        ],
        dropBoxes: [
          { answer: null },
          { answer: null },
      ...
      catLevel4: {
        title: "Inheritance",
        instructions:
          "Sass allows you to create reusable styles using `@extend` using inheritance. `@extend` allows you to take all of the styles from one selector and apply them to another. This inheritance allows you to define a base style and then extend it with additional styles. Use `@extend` and inheritance to style the cat's ears and whiskers.",
        ...
        code: [
          ...
          {
            content:
              ".cat-whisker-left\n\n\t____________ (#2) .base-whiskers\n\ttransform: rotate(-45deg)",
          },
          {
            content:
              "____________ (#3)\n\n\t@extend .base-whiskers\n\ttransform: rotate(45deg)",
          },
        ],
        ...
        answers: [
          ...
          { text: ".cat-whisker-right", used: false },
        ],
  ...
  methods: {
    ...
    setCurrentLevel() {
      if (this.level === 1) {
        ...
        this.currentLevel = this.catLevel3;
      } else if (this.level === 4) {
        this.currentLevel = this.catLevel4;
      }
    },
